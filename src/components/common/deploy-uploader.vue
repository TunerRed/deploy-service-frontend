<template>
    <div>
      <el-upload ref="uploadform" :action="uploadURL" multiple
                 :auto-upload="false" :http-request="(file)=>{this.formData.append('file', file.file)}"
                 :before-upload="beforeUpload" >
        <el-button slot="trigger" type="primary" size="small"><i class="el-icon-search"></i> 选取文件</el-button>
